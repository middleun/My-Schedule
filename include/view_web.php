<div class="categoryTabs">
    ...
    <a href="/myschedule/pages/sch_view.php?key=view_web" class="active"><i class="fa fa-chart-bar"></i></a>
</div>
<ul class="boardTable">
    <li class="boardTitle">
    ...
    <?php
        ...
        $sql="select * from sch_txt where sch_txt_cat = 'webProject' order by sch_txt_num desc";
