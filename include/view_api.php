<div class="categoryTabs">
    ...
    <a href="/myschedule/pages/sch_view.php?key=view_api" class="active"><i class="fa fa-film"></i></a>
...
<ul class="boardTable">
    ...
    <?php
        ...
        $sql="select * from sch_txt where sch_txt_cat = 'apiProject' order by sch_txt_num desc";
